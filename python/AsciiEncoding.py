...
def decode(encoded):
    ...
    while i < l: 
        ...
        # print(cur)
        if i + 1 < l:
            if (int(encodedString[i] + encodedString[i + 1]) <= 90) and (int(encodedString[i] + encodedString[i + 1]) >= 65) or int(encodedString[i] + encodedString[i + 1]) >= 97:
                ...
                if int(encodedString[i] + encodedString[i + 1] + encodedString[i + 2]) <= 122 and int(encodedString[i] + encodedString[i + 1] + encodedString[i + 2]) >= 97:
